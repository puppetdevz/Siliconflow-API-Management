import { middlewareAuthenticateAdmin } from './handlers/middleware.js';
import adminHandler from './handlers/adminHandler.js';
import { handleAPIProxy as handleModelAPI } from './handlers/modelAPIHandler.js';
...
async function handleRequest(request) {
	...
	if (path === '/admin' || path === '/admin/') {
		const isAuthenticated = await middlewareAuthenticateAdmin(request);
